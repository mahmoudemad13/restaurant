...
@section('title', __('labels.backend.orderitemoptionvalues.management') . ' | ' . __('labels.backend.orderitemoptionvalues.edit'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.orderitemoptionvalues.edit')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
