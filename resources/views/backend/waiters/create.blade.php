...
@section('title', __('labels.backend.waiters.management') . ' | ' . __('labels.backend.waiters.create'))


@section('content')
    {{ html()->form('POST', route('admin.waiters.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.waiters.create')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
