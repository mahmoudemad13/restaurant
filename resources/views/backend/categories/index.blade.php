            ...
            <div class="row">
                ...
                <div class="col-sm-7">
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                        <a href="{{ route('admin.categories.create') }}" class="btn btn-success ml-1" data-toggle="tooltip"
                ...
                <div class="col">
                    <div class="table-responsive">
                        <table class="table" id="result-table">
                            ...
                            <tr>
                                <th>#</th>
                                <th>@lang('labels.backend.categories.name')</th>
...
@push('after-scripts')
    <script>
        $dataTable('{{ route('admin.categories.index') }}', [
